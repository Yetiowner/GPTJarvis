...
# Start up fall guys then minecraft, then get if the temperature of suit 6 is greater than the temperature of suit 7. If suit 7 is hotter, start firefox, otherwise if suit 6 is hotter, start chrome.
# Is the weather in Ohio better than the weather in Libya?
